    ...
    <ScrollView style={styles.background}>
              ...
              <View style={styles.dropdown}>
                ...
                {selectedApp1 === "Callr" && (
                  <>
                    ...
                    >
                      <Picker.Item
                        label="Call outbound hangup"
                        value="Call outbound hangup"
                      />
                      <Picker.Item
                        label="Call inbound start"
                        value="Call inbound start"
                      />
                      <Picker.Item
                        label="Call outbound start"
                        value="Call outbound start"
                      />
                      <Picker.Item
                      ...
                      />
                      <Picker.Item
                        label="Call inbound hangup"
                        value="Call inbound hangup"
                      />
                      <Picker.Item
                      ...
                      <Picker.Item
                        label="Did unassigned"
                        value="Did unassigned"
                      />
                    </Picker>
                  </>
                )}
              ...
              <View style={styles.dropdown}>
                ...
                {selectedApp2 === "ChatGPT" && (
                  <>
                    ...
                    >
                      <Picker.Item
                        label="Post message sentiments"
                        value="Post message sentiments"
                      />
                      <Picker.Item
                        label="Post message categories"
                        value="Post message categories"
                      />
                      <Picker.Item
                        label="Post message summarize"
                        value="Post message summarize"
                      />
                      <Picker.Item
                ...
                {selectedApp2 === "Callr" && (
                  <>
                    ...
                    >
                      ...
                      <Picker.Item
                        label="Update media tts"
                        value="Update media tts"
                      />
                      <Picker.Item
                        label="Get list of medias"
                        value="Get list of medias"
                      />
                      <Picker.Item
                        label="Get quota status"
                        value="Get quota status"
                      />
                    </Picker>
                  </>
                )}
      ...
      <View style={styles.summaryContainer}>
        <Text style={styles.summaryText}>
          {selectedApp1 || "None"} with {selectedApp2 || "None"} when{" "}
          {selectedItemApp1 || "None"} do {selectedItemApp2 || "None"}
        </Text>
      </View>
